function [SignalMask CellBoundaryMask] = getCellMaskAndBoundary3(frame,factor_forThresholding)
%
% Created by Isabel Llorente-Garcia, August 2012.
% If you use this code please acknowledge Isabel Llorente-Garcia in your
% publications.
%
% Same as getCellMaskAndBoundary.m but with the possibility of adjusting
...
sigBWtop = im2bw(gcorr(1:half,:),factor_forThresholding*graythresh(gcorr(1:half,:))); % thresholding the top half
sigBWbottom = im2bw(gcorr(half+1:whole,:),factor_forThresholding*graythresh(gcorr(half+1:whole,:))); % thresholding the bottom half
