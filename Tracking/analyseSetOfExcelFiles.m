...
% Use this for single-label strains:
...
% all_folder_names = {'cyoA-mCherry_wholeCell_I'};
% all_folder_names = {'mCherry-nuoF_wholeCell_I'};
% all_folder_names = {'GFP-nuoF_wholeCell_I'};
% all_folder_names = {'mCherry-sdhC_wholeCell_I'};
% all_folder_names = {'cydB-GFP_wholeCell_I'};
all_folder_names = {'cyoA-mCherry_wholeCell_I'};
% all_folder_names = {'try_wholeCell_I'};

% Use this for dual-label strains:
