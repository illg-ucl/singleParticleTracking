function processedManyTrajs = showManyTrajAnalysis(image_label,n_traj_start,n_traj_end,start_frame,tsamp,pixelsize_nm,showVideo,minPointsTraj) 
%
...
% analised (default minPointsTraj = 6).
% Note that this number needs to be at least 5 for all methods in
% "showTrajAnalysis.m" to work well.
%
...
% 'SNR','BgNoiseStd','IbgAvg','IinnerTot','rsqFit'.
