...
% This is useful for dim spots, in vitro data of single
% fluorophores, etc...
%
% This function takes an image_label such as '513', '490', etc... 
% which corresponds to a certain label of image sequence file,
...
% A1=A(1:225,:); % select only the top strip of the image.
% [xA1 yA1] = findCandidateSpots(mat2gray(A1),2);
% FindTrajectsFixedCandidates('563',13,80,xA1,yA1)
%
% -------------------------------------------------------
%
