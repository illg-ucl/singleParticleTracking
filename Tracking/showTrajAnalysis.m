...
%  
% NOTE: this function fails if the no. of points in the track is <6.
%
...
xsize_default_cell_region = 80; % horizontal size of region around cell. (70-140) 
ysize_default_cell_region = 80; % horizontal size of region around cell. (70-140)
...
%% Fit intensity data to an exponentially decaying function (with no offset): BLUE
...
%% Fit intensity data to an exponentially decaying function (with offset "_wo"): RED
