...
% with fields 'trajNumber', 'xvalues', 'yvalues', 'intensity', 'msd_unavg',
...
tracks(1:numtracks) = struct('trajNumber',[],'xvalues0',[],'yvalues0',[],'xvalues',[],'yvalues',[],'intensity',[],'msd_unavg',[],'frame',[],'timeabs',[],'timerel',[],'numel',[],'minNumPointsInTraj',[],'deltaTime',[],'msd',[],'errorMsd',[],'errorMsdRelPercent',[],'disp',[]);
